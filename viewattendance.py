...
#btnfrm=Frame(rt,bd=4,relief=RIDGE,bg="gray")
#btnfrm.place(x=10,y=580,width=200,height=50)
...
#clrt=Button(btnfrm,text="CLEAR",command=cleardata,width=10).grid(row=0,column=0,padx=10,pady=10)
#backbt=Button(btnfrm,text="BACK",command=back,width=10).grid(row=0,column=1,padx=10,pady=10)
